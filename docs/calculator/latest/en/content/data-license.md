...
- [Land cover map](https://www.ceh.ac.uk/data/ukceh-land-cover-maps) (2024) under the Non-Commercial Government Licence. Data owned by UK Centre for Ecology & Hydrology© Database Right/Copyright UKCEH;
- [OS terrain 50 data](https://www.ordnancesurvey.co.uk/products/os-terrain-50) (2025) under OS open data
...
-	Ammonia (NH<sub>3</sub>) background concentration from the UK Centre for Ecology and Hydrology (UK CEH) [Concentration Based Estimated Deposition (CBED) dataset](https://catalogue.ceh.ac.uk/documents/bfa37333-b22e-41b8-829a-10c57d50e13f)
- Vehicle emission factors for nitrogen oxides (NO<sub>x</sub>) from the [Emission Factor Toolkit (EFT)](https://laqm.defra.gov.uk/air-quality/air-quality-assessment/emissions-factors-toolkit/) (v13.0) produced by Defra
- [NO<sub>x</sub> to NO<sub>2</sub> Calculator](https://laqm.defra.gov.uk/air-quality/air-quality-assessment/nox-to-no2-calculator/) (v9.1) from Local Air Quality Management (LAQM)
-	[Road traffic estimates](https://www.gov.uk/government/statistical-data-sets/road-traffic-statistics-tra) 2024 diurnal profiles from Department for Transport
-	Critical loads and levels for interest features at UK protected sites from UK Centre for Ecology and Hydrology (UKCEH)
...
-	OSNI Open Data [50m Digital Terrain Model](https://www.nidirect.gov.uk/articles/50m-digital-terrain-model-height-data) (2022)
